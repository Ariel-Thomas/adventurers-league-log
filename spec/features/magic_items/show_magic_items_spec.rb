...
RSpec.feature 'Show Magic items', type: :feature, js: true do
  ...
  context 'Character has log entries with many magic items' do
    before(:each) do
      @log_entry1 = FactoryGirl.create(:character_log_entry, characters: [@character])
      @magic_item1 = FactoryGirl.create(:magic_item, name: 'Staff of Power', log_entry: @log_entry1, character: @character)
      @magic_item2 = FactoryGirl.create(:magic_item, name: 'Cool Belt', log_entry: @log_entry1, character: @character)

      @log_entry2 = FactoryGirl.create(:character_log_entry, characters: [@character])
      @log_entry3 = FactoryGirl.create(:character_log_entry, characters: [@character])
      @magic_item3 = FactoryGirl.create(:magic_item, name: 'Awesome Armor', log_entry: @log_entry3, character: @character)
      @magic_item4 = FactoryGirl.create(:magic_item, name: 'Big Sword', log_entry: @log_entry3, character: @character)
