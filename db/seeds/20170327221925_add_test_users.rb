    ...
    @users.each do |user|
      (5 + rand(10)).times do
        user.dm_log_entries.create(
          date_dmed:        Faker::Date.forward(days: 365),
          date_played:      Faker::Date.forward(days: 366),
          adventure_title:  'DDAL01-01 The Beginning',
          session_num:      Faker::Number.between(from: 100, to: 10_000),
      ...
      4.times do
        ...
        (5 + rand(10)).times do
          character.character_log_entries.create(
            ...
            adventure_title: 'DDAL01-01 The Beginning',
            session_num: Faker::Number.between(from: 1, 10),
            xp_gained: Faker::Number.between(from: 200, 10_000),
            gp_gained: Faker::Number.between(from: 200, 10_000),
            renown_gained: 1,
            downtime_gained: 10,
            location_played: 'GenCon',
            ...
            notes: Faker::Company.bs,
            num_secret_missions: Faker::Number.between(from: 0, 1) )
        end
